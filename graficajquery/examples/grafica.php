  ...
  <!-- <script type="text/javascript">
         ...
         $(document).ready(function() {
            chart1 = new Highcharts.Chart({
               ...
               title: {
                  text: 'CARGA MANIFESTADA POR BUQUE'
               },
               subtitle: {
                  text: ''
               },
               xAxis: {
                  categories: [<?php for ($j=1;$j<=count($categories1);$j++){echo "'".$categories1[$j]."',";}?>]
               },
               yAxis: {
                  min: 0,
                  title: {
               ...
               <?php  echo " series: [";
                  ...
                  name: ' ".$products1[$i]."  ',
                  data: [";
                  for ($j=1;$j<=count($categories1);$j++) {echo $valeur[$products1[$i]][$categories1[$j]].",";}
                  echo "]},";
                  }
                  echo "
                  ]";?>
   ...
   <body background="file:///C|/wamp/www/dise/bg.gif">
      ...
      <!-- 3. Add the container  <div id="container1" style="width:600px; height: 500px; margin: 0 auto"></div>-->
