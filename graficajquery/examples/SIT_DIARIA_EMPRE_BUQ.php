...
$query="SELECT nb_proveed_benef, NB_BUQUE, COD_BL, DS_PRODUCTO, TOTAL, POR_INGRESAR, EN_MUELLE, DESPACHADOS
FROM VIEW_GRAPH_SITUACION_DIARIA_EMPRESA where id_buque = $id";
